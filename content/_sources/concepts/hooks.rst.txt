...
Burr has a system of lifecycle adapters (adapted from the similar `Hamilton <https://github.com/apache/hamilton>`_ concept), which allow you to run tooling before and after
